...
$subject = "[".$config['cf_title']."] " . __(theme_t1408);
...
$content .= addslashes($mb['mb_name'])." (".addslashes($mb['mb_nick']).")"." " . __(theme_t1400, G5_TIME_YMDHIS) . "<br>";
$content .= __(theme_t1401) . '<br>';
$content .= __(theme_t1402) . ' <span style="color:#ff3061"><strong>' . __(theme_t1403) . '</strong> ' . __(theme_t1404) . '</span><br>';
$content .= __(theme_t1405) . '<br>';
$content .= __(theme_t1406);
$content .= '</p>';
$content .= '<p style="margin:0;padding:30px 30px 30px;border-bottom:1px solid #eee;line-height:1.7em">';
$content .= '<span style="display:inline-block;width:100px">' . __(theme_t678) . '</span> '.$mb['mb_id'].'<br>';
$content .= '<span style="display:inline-block;width:100px">' . __(theme_t1407) . '</span> <strong style="color:#ff3061">'.$change_password.'</strong>';
$content .= '</p>';
$content .= '<a href="'.$href.'" target="_blank" style="display:block;padding:30px 0;background:#484848;color:#fff;text-decoration:none;text-align:center">' . __(theme_t1403) . '</a>';
$content .= '</div>';
$content .= '</div>';

mailer($config['cf_admin_email_name'], $config['cf_admin_email'], $mb['mb_email'], $subject, $content, 1);

alert_close($email. __(core_a98));
?>
