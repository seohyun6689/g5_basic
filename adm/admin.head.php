...
<header id="hd">
    <div id="hd_wrap" class="clearfix">
        ...
        <div id="logo"><a href="<?php echo G5_ADMIN_URL ?>"><?php echo $config['cf_title'] ?></a></div>

        <div class="top_menu">
            <ul id="tnb">
                <li><a href="<?php echo G5_ADMIN_URL ?>/member_form.php?w=u&amp;mb_id=<?php echo $member['mb_id'] ?>" class="tnb_icon_info">관리자정보</a></li>
                <li><a href="<?php echo G5_ADMIN_URL ?>/config_form.php" class="tnb_icon_basic">기본환경</a></li>
                <li><a href="<?php echo G5_ADMIN_URL ?>/service.php" class="tnb_icon_service">부가서비스</a></li>
                <li><a href="<?php echo G5_URL ?>/" class="tnb_icon_home">홈페이지</a></li>
...
<div id="lnb_bg"<?php echo (defined('_INDEX_') ? ' class="index" ' : ''); ?>>

        <?php if($sub_menu) { ?>

        <nav class="left_menu">
            <div class="lnb_title"><?php echo $menu['menu'.substr($sub_menu, 0, 3)][0][1] ?></div>
            <ul id="lnb">
            <?php
