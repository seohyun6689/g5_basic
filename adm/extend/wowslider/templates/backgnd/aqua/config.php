...
$params->Border = (int)$params->noFrame ? "none": "9px solid #FFFFFF";

array_push($files, (object)array( 'src' => 'backgnd/'.$params->TemplateName.'/bullet.png', 'dest' => '$ImgPath$bullet.png' ) );
array_push($files, (object)array( 'src' => 'backgnd/'.$params->TemplateName.'/arrows.png', 'dest' => '$ImgPath$arrows.png' ) );
