...
add_javascript( '<script type="text/javascript" src="' . G5_PLUGIN_URL . '/ace-builds/src-min-noconflict/ace.js" charset="utf-8"></script>', 0 );
?>
...
<div class="tbl_frm01 tbl_wrap">
    ...
    <tr>
        <th scope="row">내용</th>
        <td>
	        <textarea id="co_content" name="co_content" class="co_content" ><?php echo $co['co_content']; ?></textarea>
			<div id="co_content_editor"><?php echo htmlspecialchars($co['co_content']); ?></div>
	    </td>
    </tr>
    <tr>
        <th scope="row">모바일 내용</th>
        <td>
	        <textarea id="co_mobile_content" name="co_mobile_content" class="co_content"><?php echo $co['co_mobile_content']; ?></textarea>
	        <div id="co_mobile_content_editor"><?php echo htmlspecialchars($co['co_mobile_content']); ?></div>
	    </td>
    </tr>
    <tr>
...
var co_content_editor = null;
var co_mobile_content_editor = null;
var co_content = $('#co_content');
var co_mobile_content = $('#co_mobile_content');
$(document).ready(function(){
	co_content_editor = ace.edit("co_content_editor");
    co_content_editor.setTheme("ace/theme/chrome");
    co_content_editor.getSession().setMode("ace/mode/php");
    co_content_editor.getSession().setUseWrapMode(true);
    co_content_editor.getSession().setWrapLimitRange();
    ...
    co_mobile_content_editor.getSession().setUseWrapMode(true);
    co_mobile_content_editor.getSession().setWrapLimitRange();
	co_mobile_content_editor.getSession().on('change', function(){
