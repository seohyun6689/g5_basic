...
if(!sql_query(" DESCRIBE {$g5['menu_table']} ", false)) {
    sql_query(" CREATE TABLE IF NOT EXISTS `{$g5['menu_table']}` (
                  ...
                  `me_group` char(1) NOT NULL DEFAULT 'P',
...
$sql = " select * from {$g5['menu_table']} where me_group = 'M' order by me_order asc, me_id asc ";
...
<input type="hidden" name="me_group" value="M">

<div class="btn_add01 btn_add">
	<a href="../menu_list.php">PC용 메뉴</a>
