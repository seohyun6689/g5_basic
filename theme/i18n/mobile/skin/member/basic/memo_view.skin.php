...
<div id="memo_view" class="new_win mbskin">
    ...
    <article id="memo_view_contents">
        ...
        <ul id="memo_view_ul">
            ...
            <li class="memo_view_li">
                <span class="memo_view_subj"><?php echo $kind_date ?></span>
    ...
    <div class="win_btn">
        ...
        <?php } ?>
        <?php if ($kind == 'recv') { ?><a href="./memo_form.php?me_recv_mb_id=<?php echo $mb['mb_id'] ?>&amp;me_id=<?php echo $memo['me_id'] ?>" class="btn01"><?php echo __(theme_t797); ?></a><?php } ?>
