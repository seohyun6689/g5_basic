...
<div id="formmail" class="new_win mbskin">
    ...
    <div class="tbl_frm01 tbl_wrap">
        ...
        <?php if (!$is_member) { ?>
        <tr>
            <th scope="row"><label for="fnick"><?php echo __(theme_t452); ?><strong class="sound_only">필수</strong></label></th>
        ...
        <?php } ?>
        <tr>
            <th scope="row"><label for="subject"><?php echo __(theme_t422); ?><strong class="sound_only">필수</strong></label></th>
        ...
        <tr>
            <th scope="row"><label for="content"><?php echo __(theme_t423); ?><strong class="sound_only">필수</strong></label></th>
